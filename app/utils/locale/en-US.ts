...
export const pages = {
  ...
  songs: {
    ...
    broadcast: {
      ...
      // listener count
      listenerCount: (count: number) => `${count} listening`,
      listenerNone: 'No listener stats',
      // auto-advance queue
      nextUp: 'Next',
      queueRemaining: (count: number) => `${count} more queued`,
      queueTitle: 'Playlist queue',
      queueDesc: 'Pick songs from today’s schedule; playback moves on automatically.',
      queueEmpty: 'The queue is empty',
      queueEmptyHint: 'Tick songs below to add them — the order here is the play order',
      queueSaved: 'Queue updated',
      queueLoadFailed: 'Failed to load the queue',
      queueSaveFailed: 'Failed to save the queue',
      queueOpen: 'Queue',
      queueClear: 'Clear',
      queueSource: 'Today’s schedule',
      queueTotal: (count: number) => `${count} in queue`,
      queueCurrent: 'On air',
      playNext: 'Next track',
      advanceFailed: 'Failed to skip',
      autoAdvanceLabel: 'Auto advance',
      autoAdvanceHint: 'Move to the next queued track automatically when one finishes',
      idleReleaseLabel: 'Auto release baseline',
      idleReleaseHint: 'Release the baseline slot after this much inactivity while nothing is on air (0 = off)',
      idleReleaseUnit: 'sec',
      listenersEnabledLabel: 'Count listeners',
      listenersEnabledHint: 'Show how many people are listening (count only, no identities)',
      // takeover and release
      takeover: 'Take over',
      takeoverConfirm: (name: string) => `Take over broadcasting from ${name}? The current broadcast will stop.`,
      takeoverDone: 'You took over the broadcast controls',
      takeoverBusy: (name: string) => `${name} is still broadcasting — try again later`,
      takeoverNoTarget: 'No baseline broadcaster is set — just start playing',
      takeoverAlready: 'You are already the baseline broadcaster',
      release: 'Hand back',
      releaseConfirm: 'Every song admin will be able to broadcast again. Continue?',
      releaseDone: 'Broadcast controls handed back',
      takeoverFailed: 'Takeover failed',
      releaseFailed: 'Hand back failed',
      // broadcast baseline settings
      settings: 'Broadcast settings',
      settingsTitle: 'Broadcast settings',
      settingsDesc: 'Choose who may sync their playback to every student page and classroom display.',
      enabledLabel: 'Allow broadcasting',
      enabledHint: 'When off, nobody can go on air and students lose the on-air bar immediately',
      baselineLabel: 'Baseline broadcaster',
      baselineRoleOnly: 'Anyone with song admin or above',
      baselineRoleOnlyHint: 'Any song admin or above may broadcast — good for rotating shifts',
      baselineUserHint: (name: string) => `Only ${name} may go on air`,
      baselineStale: 'The designated broadcaster is no longer valid (deleted, disabled or demoted); the role baseline is in effect',
      baselineNotAllowed: (name: string) => `${name} is the current baseline broadcaster, so you cannot go on air`,
      noPermission: 'You are not allowed to broadcast',
      staffReady: 'Ready to broadcast',
      staffReadyHint: 'Play a song to sync it to students and classroom displays',
      staffDisabled: 'Broadcasting has been disabled by an admin',
      save: 'Save',
      cancel: 'Cancel',
      saveSuccess: 'Broadcast settings saved',
      saveFailed: 'Failed to save',
